...
//        return firebaseMessaging.sendMulticast(message);
//    }
        public BatchResponse sendNonPeople(fpt.aptech.KHR.NewEntities.Notifacation contentNotification,Account acc) throws FirebaseMessagingException {
        Notification notification = Notification
                .builder()
                .setTitle(contentNotification.getTitle())
                .setBody(contentNotification.getConntent())
                .build();
        MulticastMessage message = MulticastMessage
                .builder()
                ///lay token
                .addToken(acc.getToken())
                .setNotification(notification)
                .build();
        // firebaseMessaging.
        return firebaseMessaging.sendMulticast(message);
    }
        public BatchResponse sendDataPeople(fpt.aptech.KHR.NewEntities.Notifacation contentNotification,Account acc,String type) throws FirebaseMessagingException {
        Notification notification = Notification
                .builder()
                .setTitle(contentNotification.getTitle())
                .setBody(contentNotification.getConntent())
        ...
        MulticastMessage message = MulticastMessage
                ...
                .setNotification(notification)
                .putData("type", type)
                .putData("value", contentNotification.getDatatran())
                .build();
        // firebaseMessaging.
        return firebaseMessaging.sendMulticast(message);
    }
